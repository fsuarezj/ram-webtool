...
/**
 * Provides the local service interface for Assessment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fsuarezj
 * @see AssessmentLocalServiceUtil
...
public interface AssessmentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssessmentLocalServiceUtil} to access the assessment local service. Add custom service methods to {@link com.lrc.liferay.ram.service.impl.AssessmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
