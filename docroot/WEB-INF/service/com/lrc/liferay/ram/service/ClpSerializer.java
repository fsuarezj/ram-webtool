...
import com.lrc.liferay.ram.model.AssessmentClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"ram-webtool-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "ram-webtool-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.lrc.liferay.ram.model.impl.AssessmentImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.lrc.liferay.ram.AssessmentNameException")) {
			return new com.lrc.liferay.ram.AssessmentNameException();
		}

		if (className.equals("com.lrc.liferay.ram.NoSuchAssessmentException")) {
			return new com.lrc.liferay.ram.NoSuchAssessmentException();
		}
