...
/**
 * The persistence utility for the wrapper step service. This utility wraps {@link WrapperStepPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WrapperStepUtil {
	 ...
	 */
	public static void clearCache(WrapperStep wrapperStep) {
		getPersistence().clearCache(wrapperStep);
	}
	 ...
	 */
	public static List<WrapperStep> findWithDynamicQuery(
	 ...
	 */
	public static WrapperStep update(WrapperStep wrapperStep)
		throws SystemException {
		return getPersistence().update(wrapperStep);
	}
	...
	public static WrapperStep update(WrapperStep wrapperStep,
		...
		return getPersistence().update(wrapperStep, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(wrapperStep);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(wrapperSteps);
	}
	...
	*/
	public static org.lrc.liferay.toolbuilder.model.WrapperStep create(
		long wrapperStepId) {
		return getPersistence().create(wrapperStepId);
	}
	...
	*/
	public static org.lrc.liferay.toolbuilder.model.WrapperStep remove(
		long wrapperStepId)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.lrc.liferay.toolbuilder.NoSuchWrapperStepException {
		return getPersistence().remove(wrapperStepId);
	}

	public static org.lrc.liferay.toolbuilder.model.WrapperStep updateImpl(
		org.lrc.liferay.toolbuilder.model.WrapperStep wrapperStep)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(wrapperStep);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.lrc.liferay.toolbuilder.model.WrapperStep findByPrimaryKey(
		long wrapperStepId)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.lrc.liferay.toolbuilder.NoSuchWrapperStepException {
		return getPersistence().findByPrimaryKey(wrapperStepId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.lrc.liferay.toolbuilder.model.WrapperStep fetchByPrimaryKey(
		long wrapperStepId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(wrapperStepId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.lrc.liferay.toolbuilder.model.WrapperStep> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static WrapperStepPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WrapperStepPersistence)PortletBeanLocatorUtil.locate(org.lrc.liferay.toolbuilder.service.ClpSerializer.getServletContextName(),
					WrapperStepPersistence.class.getName());

			ReferenceRegistry.registerReference(WrapperStepUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(WrapperStepPersistence persistence) {
	}

	private static WrapperStepPersistence _persistence;
}