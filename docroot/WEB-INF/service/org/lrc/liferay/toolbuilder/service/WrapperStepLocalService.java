...
/**
 * Provides the local service interface for WrapperStep. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Fernando Suárez
 * @see WrapperStepLocalServiceUtil
...
public interface WrapperStepLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WrapperStepLocalServiceUtil} to access the wrapper step local service. Add custom service methods to {@link org.lrc.liferay.toolbuilder.service.impl.WrapperStepLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
