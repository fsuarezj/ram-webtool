...
/**
 * Provides the local service interface for InstalledSteps. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Fernando Suárez
 * @see InstalledStepsLocalServiceUtil
...
public interface InstalledStepsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InstalledStepsLocalServiceUtil} to access the installed steps local service. Add custom service methods to {@link org.lrc.liferay.toolbuilder.service.impl.InstalledStepsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
